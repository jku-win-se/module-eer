 ...
 * </p>
 * <ul>
 *   <li>{@link org.module.eer.mm.moduleeer.impl.NameElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NameElementImpl extends MinimalEObjectImpl.Container implements NameElement {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModuleeerPackage.NAME_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModuleeerPackage.NAME_ELEMENT__NAME:
			return getName();
		}
