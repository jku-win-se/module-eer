...
public class ModularizableDependenciesConstraint implements Constraint<IntegerGene,Double> {

	private Map<Integer, List<Integer>> mapOfRelationships; 
	
	public ModularizableDependenciesConstraint(Map<Integer, List<Integer>> mapOfRelationships) {
